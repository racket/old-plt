...
static Scheme_Object *os_wxMediaBufferGetFilename(int n,  Scheme_Object *p[])
{
  ...
  if (n > (POFFSET+0) && !XC_SCHEME_NULLP(p[POFFSET+0]))
    WITH_VAR_STACK(objscheme_set_box(p[POFFSET+0], (_x0 ? scheme_true : scheme_false)));
...
static Scheme_Object *os_wxMediaBufferPutFile(int n,  Scheme_Object *p[])
{
  ...
  x0 = (nstring)WITH_VAR_STACK(objscheme_unbundle_nullable_string(p[POFFSET+0], "put-file in editor<%>"));
  x1 = (nstring)WITH_VAR_STACK(objscheme_unbundle_nullable_string(p[POFFSET+1], "put-file in editor<%>"));
...
static Scheme_Object *os_wxMediaBufferGetFile(int n,  Scheme_Object *p[])
{
  ...
  x0 = (nstring)WITH_VAR_STACK(objscheme_unbundle_nullable_string(p[POFFSET+0], "get-file in editor<%>"));
...
static Scheme_Object *os_wxMediaBufferOnLoadFile(int n,  Scheme_Object *p[])
{
  ...
  x0 = (string)WITH_VAR_STACK(objscheme_unbundle_string(p[POFFSET+0], "on-load-file in editor<%>"));
...
static Scheme_Object *os_wxMediaBufferCanLoadFile(int n,  Scheme_Object *p[])
{
  ...
  x0 = (string)WITH_VAR_STACK(objscheme_unbundle_string(p[POFFSET+0], "can-load-file? in editor<%>"));
...
static Scheme_Object *os_wxMediaBufferOnSaveFile(int n,  Scheme_Object *p[])
{
  ...
  x0 = (string)WITH_VAR_STACK(objscheme_unbundle_string(p[POFFSET+0], "on-save-file in editor<%>"));
...
static Scheme_Object *os_wxMediaBufferCanSaveFile(int n,  Scheme_Object *p[])
{
  ...
  x0 = (string)WITH_VAR_STACK(objscheme_unbundle_string(p[POFFSET+0], "can-save-file? in editor<%>"));
...
static Scheme_Object *os_wxMediaBufferSetFilename(int n,  Scheme_Object *p[])
{
  ...
  x0 = (nstring)WITH_VAR_STACK(objscheme_unbundle_nullable_string(p[POFFSET+0], "set-filename in editor<%>"));
  if (n > (POFFSET+1)) {
...
void objscheme_setup_wxMediaBuffer(Scheme_Env *env)
{
  ...
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "dc-location-to-editor-location" " method", os_wxMediaBufferwxbDCToBuffer, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "editor-location-to-dc-location" " method", os_wxMediaBufferwxbBufferToDC, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-inactive-caret-threshold" " method", os_wxMediaBufferSetInactiveCaretThreshold, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-inactive-caret-threshold" " method", os_wxMediaBufferGetInactiveCaretThreshold, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-focus-snip" " method", os_wxMediaBufferGetFocusSnip, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "end-write-header-footer-to-file" " method", os_wxMediaBufferEndWriteHeaderFooterToFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "begin-write-header-footer-to-file" " method", os_wxMediaBufferBeginWriteHeaderFooterToFile, 3, 3));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "print" " method", os_wxMediaBufferPrint, 0, 4));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "insert-image" " method", os_wxMediaBufferInsertImage, 0, 4));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "insert-box" " method", os_wxMediaBufferInsertBox, 0, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-filename" " method", os_wxMediaBufferGetFilename, 0, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "is-modified?" " method", os_wxMediaBufferModified, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "is-locked?" " method", os_wxMediaBufferIsLocked, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "lock" " method", os_wxMediaBufferLock, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-cursor" " method", os_wxMediaBufferSetCursor, 1, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-paste-text-only" " method", os_wxMediaBufferGetPasteTextOnly, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-paste-text-only" " method", os_wxMediaBufferSetPasteTextOnly, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-load-overwrites-styles" " method", os_wxMediaBufferGetLoadOverwritesStyles, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-load-overwrites-styles" " method", os_wxMediaBufferSetLoadOverwritesStyles, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-style-list" " method", os_wxMediaBufferSetStyleList, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-style-list" " method", os_wxMediaBufferGetStyleList, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-keymap" " method", os_wxMediaBufferGetKeymap, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-keymap" " method", os_wxMediaBufferSetKeymap, 0, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "can-do-edit-operation?" " method", os_wxMediaBufferCanEdit, 1, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "do-edit-operation" " method", os_wxMediaBufferDoEdit, 1, 3));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-max-undo-history" " method", os_wxMediaBufferGetMaxUndoHistory, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-max-undo-history" " method", os_wxMediaBufferSetMaxUndoHistory, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "add-undo" " method", os_wxMediaBufferAddSchemeUndo, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "clear-undos" " method", os_wxMediaBufferClearUndos, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "redo" " method", os_wxMediaBufferRedo, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "undo" " method", os_wxMediaBufferUndo, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "select-all" " method", os_wxMediaBufferSelectAll, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "clear" " method", os_wxMediaBufferClear, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-view-size" " method", os_wxMediaBufferGetViewSize, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-dc" " method", os_wxMediaBufferGetDC, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "local-to-global" " method", os_wxMediaBufferLocalToGlobal, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "global-to-local" " method", os_wxMediaBufferGlobalToLocal, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-admin" " method", os_wxMediaBufferSetAdmin, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-admin" " method", os_wxMediaBufferGetAdmin, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "print-to-dc" " method", os_wxMediaBufferPrintToDC, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "find-scroll-line" " method", os_wxMediaBufferFindScrollLine, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "num-scroll-lines" " method", os_wxMediaBufferNumScrollLines, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "scroll-line-location" " method", os_wxMediaBufferScrollLineLocation, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-snip-location" " method", os_wxMediaBufferGetSnipLocation, 1, 4));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "refresh-delayed?" " method", os_wxMediaBufferRefreshDelayed, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "end-edit-sequence" " method", os_wxMediaBufferEndEditSequence, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "begin-edit-sequence" " method", os_wxMediaBufferBeginEditSequence, 0, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "style-has-changed" " method", os_wxMediaBufferStyleHasChanged, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "write-to-file" " method", os_wxMediaBufferWriteToFile, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "read-from-file" " method", os_wxMediaBufferReadFromFile, 1, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-min-height" " method", os_wxMediaBufferSetMinHeight, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-max-height" " method", os_wxMediaBufferSetMaxHeight, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-min-height" " method", os_wxMediaBufferGetMinHeight, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-max-height" " method", os_wxMediaBufferGetMaxHeight, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-min-width" " method", os_wxMediaBufferSetMinWidth, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-max-width" " method", os_wxMediaBufferSetMaxWidth, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-min-width" " method", os_wxMediaBufferGetMinWidth, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-max-width" " method", os_wxMediaBufferGetMaxWidth, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-space" " method", os_wxMediaBufferGetSpace, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-descent" " method", os_wxMediaBufferGetDescent, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-extent" " method", os_wxMediaBufferGetExtent, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "insert-file" " method", os_wxMediaBufferInsertFile, 1, 3));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "save-file" " method", os_wxMediaBufferSaveFile, 0, 3));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "load-file" " method", os_wxMediaBufferLoadFile, 0, 3));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-flattened-text" " method", os_wxMediaBufferGetFlattenedText, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "put-file" " method", os_wxMediaBufferPutFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-file" " method", os_wxMediaBufferGetFile, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "after-edit-sequence" " method", os_wxMediaBufferAfterEditSequence, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-edit-sequence" " method", os_wxMediaBufferOnEditSequence, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "after-load-file" " method", os_wxMediaBufferAfterLoadFile, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-load-file" " method", os_wxMediaBufferOnLoadFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "can-load-file?" " method", os_wxMediaBufferCanLoadFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "after-save-file" " method", os_wxMediaBufferAfterSaveFile, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-save-file" " method", os_wxMediaBufferOnSaveFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "can-save-file?" " method", os_wxMediaBufferCanSaveFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-new-box" " method", os_wxMediaBufferOnNewBox, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-new-image-snip" " method", os_wxMediaBufferOnNewImageSnip, 4, 4));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "invalidate-bitmap-cache" " method", os_wxMediaBufferInvalidateBitmapCache, 0, 4));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-paint" " method", os_wxMediaBufferOnPaint, 9, 9));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "write-footers-to-file" " method", os_wxMediaBufferWriteFootersToFile, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "write-headers-to-file" " method", os_wxMediaBufferWriteHeadersToFile, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "read-footer-from-file" " method", os_wxMediaBufferReadFooterFromFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "read-header-from-file" " method", os_wxMediaBufferReadHeaderFromFile, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-filename" " method", os_wxMediaBufferSetFilename, 1, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "release-snip" " method", os_wxMediaBufferReleaseSnip, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-modified" " method", os_wxMediaBufferSetModified, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-snip-data" " method", os_wxMediaBufferSetSnipData, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "get-snip-data" " method", os_wxMediaBufferGetSnipData, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "needs-update" " method", os_wxMediaBufferNeedsUpdate, 5, 5));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "resized" " method", os_wxMediaBufferResized, 2, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "set-caret-owner" " method", os_wxMediaBufferSetCaretOwner, 1, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "scroll-to" " method", os_wxMediaBufferScrollTo, 6, 7));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-display-size" " method", os_wxMediaBufferOnDisplaySize, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-change" " method", os_wxMediaBufferOnChange, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-focus" " method", os_wxMediaBufferOnFocus, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-default-char" " method", os_wxMediaBufferOnDefaultChar, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-default-event" " method", os_wxMediaBufferOnDefaultEvent, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-local-char" " method", os_wxMediaBufferOnLocalChar, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-local-event" " method", os_wxMediaBufferOnLocalEvent, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "find-first-snip" " method", os_wxMediaBufferFindFirstSnip, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "blink-caret" " method", os_wxMediaBufferBlinkCaret, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "own-caret" " method", os_wxMediaBufferOwnCaret, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "refresh" " method", os_wxMediaBufferRefresh, 5, 5));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "adjust-cursor" " method", os_wxMediaBufferAdjustCursor, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-char" " method", os_wxMediaBufferOnChar, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "on-event" " method", os_wxMediaBufferOnEvent, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "copy-self-to" " method", os_wxMediaBufferCopySelfTo, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "copy-self" " method", os_wxMediaBufferCopySelf, 0, 0));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "kill" " method", os_wxMediaBufferKill, 0, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "paste" " method", os_wxMediaBufferPaste, 0, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "copy" " method", os_wxMediaBufferCopy, 0, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "cut" " method", os_wxMediaBufferCut, 0, 2));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "insert" " method", os_wxMediaBufferInsert, 1, 1));
  WITH_VAR_STACK(scheme_add_method_w_arity(os_wxMediaBuffer_class, "change-style" " method", os_wxMediaBufferChangeStyle, 1, 1));
