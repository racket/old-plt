...
MZ_EXTERN Scheme_Object *scheme_make_integer_value_from_long_long(unsigned long lohalf, unsigned long hihalf);
MZ_EXTERN Scheme_Object *scheme_make_integer_value_from_unsigned_long_long(unsigned long lohalf, unsigned long hihalf);
