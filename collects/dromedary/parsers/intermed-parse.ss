#cs
(module intermed-parse mzscheme
	(require "general-parse.ss"
		 (prefix ast: "../ast.ss"))

	(provide parse-intermed-ml-file parse-intermed-ml-port)
...
;; Miscellaneous
  ...
  (define (parse-intermed-ml-port port file offset)
    (parse-ml-port port file offset parse))
  
  (define (parse-intermed-ml-file file)
