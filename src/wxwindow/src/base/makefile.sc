...
wb_cmdlg.obj wx_time.obj wx_frac.obj
...
wb_print.obj:     wb_print.cc $(BASEINC)\wx_print.h

wx_mem.obj:     wx_mem.cc $(BASEINC)\wx_mem.h
...
wb_res.obj: $(BASEINC)\wx_res.h wb_res.cc

wb_stat.obj: $(MSWINC)\wx_stat.h wb_stat.cc

wb_scrol.obj: $(MSWINC)\wx_scrol.h wx_scrol.cc

wb_vlbox.obj: $(MSWINC)\wx_vlbox.h wb_vlbox.cc

wx_lay.obj: $(BASEINC)\wx_lay.h wx_lay.cc

wx_doc.obj: $(BASEINC)\wx_doc.h wx_doc.cc

wx_tbar.obj: $(BASEINC)\wx_tbar.h wx_tbar.cc

wx_bbar.obj: $(BASEINC)\wx_bbar.h wx_bbar.cc

wx_date.obj: $(BASEINC)\wx_date.h wx_date.cc

wx_time.obj: $(BASEINC)\wx_time.h wx_time.cc

wx_frac.obj: $(BASEINC)\wx_frac.h wx_frac.cc

wb_cmdlg.obj: $(BASEINC)\wb_cmdlg.h wb_cmdlg.cc
