	  ...
	  (make-dispatch-table
	   ...
	   (list (cons eof-tok end-action)
		 ...
		 (cons lbrack-rbrack-tok
		       (lambda (tok loop)
			 (cons (parse-class (list (cons rbrack-ch rbrack-ch))
					    #f
					    (get-tok-line tok)
					    (get-tok-column tok))
			       (loop))))
		 ...
		 (cons lbrack-minus-tok
		       (lambda (tok loop)
			 (cons (parse-class (list (cons minus-ch minus-ch))
					    #f
					    (get-tok-line tok)
					    (get-tok-column tok))
			       (loop))))
		 (cons doublequote-tok
		       (lambda (tok loop)
			 (cons (parse-string (get-tok-line tok)
					     (get-tok-column tok))
			       (loop))))
		 (cons illegal-tok
		       (lambda (tok loop)
