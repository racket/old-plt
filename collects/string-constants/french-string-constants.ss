(
 ...
 (mrflow-unknown-style-error-title "Style de boîte inconnu")
 (mrflow-unknown-style-error "Style de boîte inconnu: ~a")
 ...
 (mrflow-unknwon-exception "Exception inconnue: ~a")
