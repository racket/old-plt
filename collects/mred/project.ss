(define mred:project@
  (unit/s mred:project^
    (import [mred:debug mred:debug^] [mred:group mred:group^]
	    [mred:gui-utils mred:gui-utils^] [mred:exit mred:exit^]
	    [mred:finder mred:finder^]
	    [mred:frame mred:frame^] [mred:handler mred:handler^]
	    [mzlib:file mzlib:file^] [mzlib:function mzlib:function^])
