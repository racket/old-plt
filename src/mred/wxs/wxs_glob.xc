...
@ "file-selector" : nstring wxFileSelector(nstring,nstring=NULL,npathname=NULL,npathname=NULL,nstring=FILE_SEL_DEF_PATTERN,SYM[fileSelMode]=wxOPEN,wxWindow^//ubFrameDialog["file-selector"]/cFrameDialog=NULL,int=-1,int=-1);
