...
(err/rt-test (readstr "#\\uFFFF") exn:read?)
(err/rt-test (readstr "#\\UFFFF") exn:read?)
(err/rt-test (readstr "#\\UB0000000") exn:read?)
(err/rt-test (readstr "#\\UFFFFFFFF") exn:read?)
(err/rt-test (readstr "#\\uD900") exn:read?)
...
(err/rt-test (readstr "\"\\c\"") exn:read?)
(err/rt-test (readstr "\"\\777\"") exn:read?)
(err/rt-test (readstr "\"\\uFFFF\"") exn:read?)
(err/rt-test (readstr "\"\\UB0000000\"") exn:read?)
(err/rt-test (readstr "\"\\UFFFFFFFF\"") exn:read?)
