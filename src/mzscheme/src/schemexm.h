...
#define scheme_add_sble (scheme_extension_table->scheme_add_sble)
#define scheme_add_sble_through_sema (scheme_extension_table->scheme_add_sble_through_sema)
#define scheme_is_sble (scheme_extension_table->scheme_is_sble)
...
#define scheme_make_sble_set (scheme_extension_table->scheme_make_sble_set)
...
#define short (scheme_extension_table->short)
...
#define scheme_make_read_sble (scheme_extension_table->scheme_make_read_sble)
#define scheme_make_write_sble (scheme_extension_table->scheme_make_write_sble)
