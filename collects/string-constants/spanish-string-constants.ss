(
 ...
 (kill? "¿Terminar?")
   ...
   (&stop "&Detener")
   (advanced-one-line-summary "Intermedio con lambda y mutación")
   ...
   (beginning/abbrev-one-line-summary "Principiante, con impresión de listas en el REPL")
   ;; REPL --> Ciclo de Lectura Escritura e Impresión (¿CLEI?)
   ...
   (intermediate/lambda-one-line-summary "Intermedio más funciones de alto nivel")
   ...
   (module-language-one-line-summary "Lenguaje con  module como la única construcción")
   (mred-one-line-summary "PLT Scheme más biblioteca IGU")
   ...
   (pls-fill-in-either-description-or-reproduce "Por favor llena ya sea el campo Descripción o el campo Pasos para reproducir")
   (plt-homepage "PLT")
   (pref-lock-not-gone "El candado de preferencias:\n\n   ~a\n\nevita que las preferencias puedan salvarse. Asegúrese de que ninguna otra instancia de software del PLT está corriendo y borre dicho archivo.")
...
(decimal-notation-for-rationals "Use notación decimal para los racionales")
(editor-prefs-panel-label "Editando")
(fraction-style "Estilo de fracción")
(happy-birthday-matthias "¡Feliz cumpleaños Matthias!")
(inline-saved-program-in-executable/windows "Advertencia: en windows también necesitas libmred.dll, libmzsch.dll, y libmzgc.dll para correr ejecutables auto-contenidos.")
...
(pretty-big-scheme-one-line-summary "Gráfico, con muchas bibliotecas estándar")
...
(use-repeating-decimals "Repetición de decimales")
