...
\scheme{points} will draw points on a graph given a list. of vectors specifying their location. Sym changes the appearance of the points (either 'circle or 'square).
...
\scheme{fit-result-final-params} returns an associative list of the parameters specified  in fit
