...
Queinnec's LiSP2TeX and Ramsdell's SchemeWeb, use
...
section~\ref{intro-example}  introduces a small example that covers the SLaTeX
control sequences you will need the most.  Both LaTeX and
plain TeX versions are shown. Section~\ref{slatex-sty-files}
describes the SLaTeX style files {\tt slatex.sty} and
{\tt cltl.sty}.  Section~\ref{glossary} provides a complete description of all
the SLaTeX control sequences.  These include commands for
manipulating output positioning, enhancing the database,
changing the fonting defaults, adding special symbols, and
selective disabling of SLaTeX. Section~\ref{preamble} offers guidelines for
setting up a preamble that reflects your typesetting
taste. Section~\ref{ftp} contains information on obtaining and installing
SLaTeX.
...
``glue'', are discussed in detail on pp.\ 70ff.\ of {\it The
TeXbook\/} (Knuth).}  that
...
\n This is close to the ``Little Schemer''
(Friedman \& Felleisen) style.  Redefine these control
sequences for font changes.  As an extreme case, defining
all of them to
\p|{{\tt#1}}| typesets everything in monospace
typewriter font, as, for instance, in SICP (Abelson \&
Sussman).
...
\enableslatex
in R5RS-compliant  Scheme (macros are not
...
\bibitem{sicp} H. Abelson and G. J. Sussman with J. Sussman,
{\it Structure and Interpretation of Computer Programs}, (``SICP''), MIT
Press, 1985.

\bibitem{little-schemer} D. P. Friedman and M. Felleisen,
{\it The Little Schemer}, 4th ed., MIT Press, 1996.

\bibitem{seasoned-schemer} D. P. Friedman and M. Felleisen,
{\it The Seasoned Schemer}, MIT Press, 1996.

\bibitem{texbook} D. E. Knuth, {\it The TeXbook},
Addison-Wesley, 1984.

\bibitem{latex-manual} L. Lamport, {\it LaTeX: A Document
Preparation System}, Addison-Wesley, 1986.

\bibitem{lisp2tex} C. Queinnec, {\it LiSP2TeX}, available from the
Scheme Repository at {\tt ftp://iuvax.cs.\allowbreak
indiana.edu/\allowbreak pub/\allowbreak
scheme-repository/\allowbreak utl/}.

\bibitem{schemeweb} J. Ramsdell, {\it SchemeWeb}, available
from the Scheme Repository.

\bibitem{r5rs} {\it Revised$^5$ Report on the Algorithmic
Language Scheme}, (``R5RS''), eds.\ R. Kelsey,  W. Clinger,
and J. Rees, 1998.
