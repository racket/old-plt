(require "server-resource-manager.ss")
...
(and (empty? (get-pool the-manager))
     (empty? (get-pool the-manager)))
...
(let ([server-resource-pool (get-pool the-manager)])
  (and 
   (eq? res1 (server-resource-pool-get (server-resource-pool-access res1 server-resource-pool)))
   (eq? res2 (server-resource-pool-get (server-resource-pool-access res2 server-resource-pool)))
   (eq? res3 (server-resource-pool-get (server-resource-pool-access res3 server-resource-pool)))
   (eq? res4 (server-resource-pool-get (server-resource-pool-access res4 server-resource-pool)))
   (eq? res5 (server-resource-pool-get (server-resource-pool-access res5 server-resource-pool)))
   (eq? res6 (server-resource-pool-get (server-resource-pool-access res6 server-resource-pool)))
   (eq? res7 (server-resource-pool-get (server-resource-pool-access res7 server-resource-pool)))
   (eq? res8 (server-resource-pool-get (server-resource-pool-access res8 server-resource-pool)))
   ))
...
(let ([connection-pool (get-pool the-manager)])
  (and (not (eq? res7 (server-resource-pool-get (server-resource-pool-access res7 connection-pool))))
       (not (eq? res8 (server-resource-pool-get (server-resource-pool-access res8 connection-pool))))))
