...
(when known-locale?
  ...
  (let-values ([(s l ok?) (string-encode-utf8->locale "a\302\200")])
    (test 3 'count l)
    (test #t 'ok ok?))
  (test-values '("abcd" 4 #t) (lambda () (string-encode-locale->utf8 "abcd")))
  (test-values '("bcd" 3 #t) (lambda () (string-encode-locale->utf8 "abcd" 1)))
  (test-values '("bc" 2 #t) (lambda () (string-encode-locale->utf8 "abcd" 1 3)))
  (test-values '("a" 1 #f) (lambda () (string-encode-locale->utf8 "a\302\200" 0 2)))
  (test-values '(2 2 #t) (lambda () (string-encode-locale->utf8 "abcd" 1 3 (make-string 2))))
  (let ([s (make-string 10)])
    (test-values '(2 2 #t) (lambda () (string-encode-locale->utf8 "abcd" 1 3 s 4 7)))
    (test #\b string-ref s 4)
    (test #\c string-ref s 5))
  (let ([s (make-string 10)])
    (test-values '(1 1 #t) (lambda () (string-encode-locale->utf8 "abcd" 1 3 s 4 5)))
    (test #\b string-ref s 4))
  ;; The rest relies on the "C" locale:
  (parameterize ([current-locale "C"])
    (test-values '("abc" 3 #t) (lambda () (string-encode-utf8->locale "abc")))
    (test-values '("a" 1 #f) (lambda () (string-encode-utf8->locale "a\300\300")))
    (test-values '("ab" 2 #f) (lambda () (string-encode-utf8->locale "ab\303")))
    ;; Well-formed, but can't be converted to "C":
    (test-values '("a" 1 #f) (lambda () (string-encode-utf8->locale "a\303\342")))))
