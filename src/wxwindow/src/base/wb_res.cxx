...
wxFont *wxResourceInterpretFontSpec(wxResourceTable& WXUNUSED(table), PrologExpr *expr)
{
...
wxMenuBar *wxResourceCreateMenuBar(char *resource, wxResourceTable *table)
{
  if (!table)
    table = &wxDefaultResourceTable;
