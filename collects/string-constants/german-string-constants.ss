(module german-string-constants "string-constant-lang.ss"
 ...
 (cs-mouse-over-variable-import "Variable ~s importiert aus ~s")
 (cs-mouse-over-syntax-import "Syntax ~s importiert aus ~s")
 ...
 (plt:hd:refresh-done "Akutalisierung der Handbücher aus CVS abgeschlossen")
 ...
 (pref-lock-not-gone
  "Die Lock-Datei für die Einstellungen:\n\n   ~a\n\nverhindert, dass die Einstellungen abgespeichert werden können. Bitte stellen Sie sicher, daß keine andere PLT-Software läuft und löschen Sie dann diese Datei.")
 ...
 (exit "Beenden")
 (quit "Beenden")
 (are-you-sure-exit "Sind Sie sicher, daß Sie das Programm beenden wollen?")
 (are-you-sure-quit "Sind Sie sicher, daß Sie das Programm beenden wollen?")
 ...
 (kill-menu-item-label "Abrrechen")
