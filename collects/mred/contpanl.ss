...
(unit/sig mred:container-panels^
  ...
  (define child-align
	...
	[(right) (- width size)])))
  (define child-offset
    (lambda (total-offset child-align)
      (case child-align
  ...
  (define horizontal-panel%
	...
	[minor-align-pos 'center])
      ...
      (public
	[minor-align-top (lambda () 
			   (set! minor-align-pos 'left)
			   (force-redraw))]
	[minor-align-center (lambda () 
			      (set! minor-align-pos 'center)
			      (force-redraw))]
	[minor-align-bottom (lambda () 
			      (set! minor-align-pos 'right)
			      (force-redraw))]
	[major-align-left (lambda ()
			    (set! major-align-pos 'left)
			    (force-redraw))]
	[major-align-center (lambda ()
			      (set! major-align-pos 'center)
			      (force-redraw))]
	[major-align-right (lambda ()
			     (set! major-align-pos 'right)
			     (force-redraw))])
	...
	[place-children
	 (make-place-children
	  ...
	  (lambda (space) (child-offset space major-align-pos))
	  child-info-y-min
	  child-info-y-stretch
	  (lambda (width size) (child-align width size minor-align-pos))
  ...
  (define vertical-panel%
	...
	[minor-align-pos 'center])
      ...
      (inherit force-redraw)
      (public
	[minor-align-left (lambda () 
			    (set! minor-align-pos 'left)
			    (force-redraw))]
	[minor-align-center (lambda () 
			      (set! minor-align-pos 'center)
			      (force-redraw))]
	[minor-align-right (lambda () 
			     (set! minor-align-pos 'right)
			     (force-redraw))]
	[major-align-top (lambda ()
			   (set! major-align-pos 'left)
			   (force-redraw))]
	[major-align-center (lambda ()
			      (set! major-align-pos 'center)
			      (force-redraw))]
	[major-align-bottom (lambda ()
			      (set! major-align-pos 'right)
			      (force-redraw))])
