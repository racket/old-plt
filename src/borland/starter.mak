...
VERSION = BCB.05.03
# ---------------------------------------------------------------------------
PROJECT = ..\..\collects\launcher\mzstart.exe
OBJFILES = ..\mzscheme\dynsrc\start.obj
RESFILES = 
MAINSOURCE = 
RESDEPEN = $(RESFILES)
LIBFILES = 
...
INCLUDEPATH = ..\mzscheme\dynsrc;$(BCB)\include
LIBPATH = $(BCB)\lib\debug;..\mzscheme\dynsrc;d:\apps\borland\CBuilder5\;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-8065 -w-par -w-8027 -w-8026 -w-aus
# ---------------------------------------------------------------------------
CFLAG1 = -Od -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -tWC -tWM -c
IDLCFLAGS = -I..\mzscheme\dynsrc -I$(BCB)\include \
