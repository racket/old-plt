...
(unit/sig ()
 ...
 `(HTML 
   ...
   (BODY 
    ...
    (P)
    "DrScheme presents Scheme via four different " 
    ,(manual-entry "drscheme" "languages" "language levels")
    ": Beginning Student, Intermediate Student, Advanced Student, and "
    "FullScheme.  The first three are called teaching languages."
    (P)
