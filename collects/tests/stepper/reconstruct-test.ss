...
(parameterize ([current-namespace beginner-wla-namespace])
  (syntax-object->datum (expand (car (string->stx-list "`(3 4 ,@(+ 4 5))")))))
;  (syntax-case (expand (string->stx-list "`(3 4 ,@(+ 4 5)))")) (#%app)
;    [(#%app . terms)
