...
class os_wxMediaPasteboard : public wxMediaPasteboard {
 public:
  ...
  void OnResize(class wxSnip* x0, float x1, float x2);
  Bool CanResize(class wxSnip* x0, float x1, float x2);
...
void os_wxMediaPasteboard::OnResize(class wxSnip* x0, float x1, float x2)
{
  Scheme_Object *p[3];
  Scheme_Object *v;
  mz_jmp_buf savebuf;
...
Bool os_wxMediaPasteboard::CanResize(class wxSnip* x0, float x1, float x2)
{
  Scheme_Object *p[3];
  Scheme_Object *v;
  mz_jmp_buf savebuf;
...
static Scheme_Object *os_wxMediaPasteboardSetScrollStep(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x0 = objscheme_unbundle_float(p[0], "set-scroll-step in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardAfterResize(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x1 = objscheme_unbundle_float(p[1], "after-resize in pasteboard%");
  x2 = objscheme_unbundle_float(p[2], "after-resize in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardOnResize(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x1 = objscheme_unbundle_float(p[1], "on-resize in pasteboard%");
  x2 = objscheme_unbundle_float(p[2], "on-resize in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardCanResize(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x1 = objscheme_unbundle_float(p[1], "can-resize? in pasteboard%");
  x2 = objscheme_unbundle_float(p[2], "can-resize? in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardAddSelected(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  if ((n >= 1) && objscheme_istype_wxSnip(p[0], NULL, 0)) {
    ...
    x2 = objscheme_unbundle_float(p[2], "add-selected in pasteboard% (rectangle case)");
    x3 = objscheme_unbundle_float(p[3], "add-selected in pasteboard% (rectangle case)");
...
static Scheme_Object *os_wxMediaPasteboardResize(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x1 = objscheme_unbundle_float(p[1], "resize in pasteboard%");
  x2 = objscheme_unbundle_float(p[2], "resize in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardDoPaste(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x0 = objscheme_unbundle_integer(p[0], "do-paste in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardDoCopy(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  x0 = objscheme_unbundle_integer(p[0], "do-copy in pasteboard%");
...
static Scheme_Object *os_wxMediaPasteboardKill(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  if (n > 0) {
    x0 = objscheme_unbundle_integer(p[0], "kill in pasteboard%");
  } else
    x0 = 0;
...
static Scheme_Object *os_wxMediaPasteboardPaste(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  if (n > 0) {
    x0 = objscheme_unbundle_integer(p[0], "paste in pasteboard%");
  } else
    x0 = 0;
...
static Scheme_Object *os_wxMediaPasteboardCopy(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  if (n > 0) {
    ...
    x0 = FALSE;
  if (n > 1) {
    x1 = objscheme_unbundle_integer(p[1], "copy in pasteboard%");
  } else
    x1 = 0;
...
static Scheme_Object *os_wxMediaPasteboardCut(Scheme_Object *obj, int n,  Scheme_Object *p[])
{
 WXS_USE_ARGUMENT(n) WXS_USE_ARGUMENT(p)
  ...
  if (n > 0) {
    ...
    x0 = FALSE;
  if (n > 1) {
    x1 = objscheme_unbundle_integer(p[1], "cut in pasteboard%");
  } else
    x1 = 0;
