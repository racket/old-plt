...
enum {
  ...
  _scheme_last_normal_type_,            /* 126 */

  scheme_rt_comp_env,                   /* 127 */
  scheme_rt_constant_binding,           /* 128 */
  scheme_rt_resolve_info,               /* 129 */
  scheme_rt_compile_info,               /* 130 */
  scheme_rt_cont_mark,                  /* 131 */
  scheme_rt_saved_stack,                /* 132 */
  scheme_rt_reply_item,                 /* 133 */
  scheme_rt_closure_info,               /* 134 */
  scheme_rt_overflow,                   /* 135 */
  scheme_rt_dyn_wind_cell,              /* 136 */
  scheme_rt_cont_mark_chain,            /* 137 */
  scheme_rt_dyn_wind_info,              /* 138 */
  scheme_rt_dyn_wind,                   /* 139 */
  scheme_rt_dup_check,                  /* 140 */
  scheme_rt_thread_memory,              /* 141 */
  scheme_rt_input_file,                 /* 142 */
  scheme_rt_input_fd,                   /* 143 */
  scheme_rt_oskit_console_input,        /* 144 */
  scheme_rt_tested_input_file,          /* 145 */
  scheme_rt_tested_output_file,         /* 146 */
  scheme_rt_indexed_string,             /* 147 */
  scheme_rt_output_file,                /* 148 */
  scheme_rt_load_handler_data,          /* 149 */
  scheme_rt_pipe,                       /* 150 */
  scheme_rt_beos_process,               /* 151 */
  scheme_rt_system_child,               /* 152 */
  scheme_rt_tcp,                        /* 153 */
  scheme_rt_write_data,                 /* 154 */
  scheme_rt_tcp_select_info,            /* 155 */
  scheme_rt_namespace_option,           /* 156 */
  scheme_rt_param_data,                 /* 157 */
  scheme_rt_will,                       /* 158 */
  scheme_rt_will_registration,          /* 159 */
  scheme_rt_struct_proc_info,           /* 160 */
  scheme_rt_linker_name,                /* 161 */
  scheme_rt_param_map,                  /* 162 */
  scheme_rt_finalization,               /* 163 */
  scheme_rt_finalizations,              /* 164 */
  scheme_rt_cpp_object,                 /* 165 */
  scheme_rt_cpp_array_object,           /* 166 */
  scheme_rt_stack_object,               /* 167 */
  scheme_rt_preallocated_object,        /* 168 */
  scheme_thread_hop_type,               /* 169 */
  scheme_rt_srcloc,                     /* 170 */
  scheme_rt_evt,                        /* 171 */
  scheme_rt_syncing,                    /* 172 */
  scheme_rt_comp_prefix,                /* 173 */
  scheme_rt_user_input,                 /* 174 */
  scheme_rt_user_output,                /* 175 */
  scheme_rt_compact_port,               /* 176 */
  scheme_rt_read_special_dw,            /* 177 */
  scheme_rt_regwork,                    /* 178 */
  scheme_rt_buf_holder,                 /* 179 */
  scheme_rt_parameterization,           /* 180 */
  scheme_rt_print_params,               /* 181 */
#endif
