...
enum {
  ...
  scheme_id_macro_type,                 /* 99 */
  scheme_evt_set_type,                  /* 100 */
  scheme_wrap_evt_type,                 /* 101 */
  scheme_handle_evt_type,               /* 102 */
  scheme_nack_guard_evt_type,           /* 103 */
  scheme_semaphore_repost_type,         /* 104 */
  scheme_channel_type,                  /* 105 */
  scheme_channel_put_type,              /* 106 */
  scheme_thread_resume_type,            /* 107 */
  scheme_thread_suspend_type,           /* 108 */
  scheme_thread_dead_type,              /* 109 */
  scheme_poll_evt_type,                 /* 110 */
  scheme_nack_evt_type,                 /* 111 */
  scheme_module_registry_type,          /* 112 */
  scheme_thread_set_type,               /* 113 */
  scheme_string_converter_type,         /* 114 */
  scheme_alarm_type,                    /* 115 */
  scheme_thread_cell_type,              /* 116 */
  scheme_channel_syncer_type,           /* 117 */
  scheme_special_comment_type,          /* 118 */
  scheme_write_evt_type,                /* 119 */
  scheme_always_evt_type,               /* 120 */
  scheme_never_evt_type,                /* 121 */
  scheme_progress_evt_type,             /* 122 */
  scheme_certifications_type,           /* 123 */
  scheme_cert_context_type,             /* 124 */

#ifdef MZTAG_REQUIRED
  _scheme_last_normal_type_,            /* 125 */

  scheme_rt_comp_env,                   /* 126 */
  scheme_rt_constant_binding,           /* 127 */
  scheme_rt_resolve_info,               /* 128 */
  scheme_rt_compile_info,               /* 129 */
  scheme_rt_cont_mark,                  /* 130 */
  scheme_rt_saved_stack,                /* 131 */
  scheme_rt_reply_item,                 /* 132 */
  scheme_rt_closure_info,               /* 133 */
  scheme_rt_overflow,                   /* 134 */
  scheme_rt_dyn_wind_cell,              /* 135 */
  scheme_rt_cont_mark_chain,            /* 136 */
  scheme_rt_dyn_wind_info,              /* 137 */
  scheme_rt_dyn_wind,                   /* 138 */
  scheme_rt_dup_check,                  /* 139 */
  scheme_rt_thread_memory,              /* 140 */
  scheme_rt_input_file,                 /* 141 */
  scheme_rt_input_fd,                   /* 142 */
  scheme_rt_oskit_console_input,        /* 143 */
  scheme_rt_tested_input_file,          /* 144 */
  scheme_rt_tested_output_file,         /* 145 */
  scheme_rt_indexed_string,             /* 146 */
  scheme_rt_output_file,                /* 147 */
  scheme_rt_load_handler_data,          /* 148 */
  scheme_rt_pipe,                       /* 149 */
  scheme_rt_beos_process,               /* 150 */
  scheme_rt_system_child,               /* 151 */
  scheme_rt_tcp,                        /* 152 */
  scheme_rt_write_data,                 /* 153 */
  scheme_rt_tcp_select_info,            /* 154 */
  scheme_rt_namespace_option,           /* 155 */
  scheme_rt_param_data,                 /* 156 */
  scheme_rt_will,                       /* 157 */
  scheme_rt_will_registration,          /* 158 */
  scheme_rt_struct_proc_info,           /* 159 */
  scheme_rt_linker_name,                /* 160 */
  scheme_rt_param_map,                  /* 161 */
  scheme_rt_finalization,               /* 162 */
  scheme_rt_finalizations,              /* 163 */
  scheme_rt_cpp_object,                 /* 164 */
  scheme_rt_cpp_array_object,           /* 165 */
  scheme_rt_stack_object,               /* 166 */
  scheme_rt_preallocated_object,        /* 167 */
  scheme_thread_hop_type,               /* 168 */
  scheme_rt_srcloc,                     /* 169 */
  scheme_rt_evt,                        /* 170 */
  scheme_rt_syncing,                    /* 171 */
  scheme_rt_comp_prefix,                /* 172 */
  scheme_rt_user_input,                 /* 173 */
  scheme_rt_user_output,                /* 174 */
  scheme_rt_compact_port,               /* 175 */
  scheme_rt_read_special_dw,            /* 176 */
  scheme_rt_regwork,                    /* 177 */
  scheme_rt_buf_holder,                 /* 178 */
  scheme_rt_parameterization,           /* 179 */
  scheme_rt_print_params,               /* 180 */
#endif
