...
; Bad dates
(err/rt-test (find-seconds 0 0 0 0 0 1990) exn:user?)
(err/rt-test (find-seconds 0 0 0 0 1 1990) exn:user?)
(err/rt-test (find-seconds 0 0 0 1 0 1990) exn:user?)

; Early/late
(err/rt-test (find-seconds 0 0 0 1 1 1490) exn:user?)
(err/rt-test (find-seconds 0 0 0 1 1 2890) exn:user?)
...
(let ([s (find-seconds 1 0 3 1 4 1990)]) ; ok
  (when (date-dst? (seconds->date s))
	...
	(err/rt-test (find-seconds 0 1 2 1 4 1990) exn:user?)
