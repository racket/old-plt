...
enum {
  ...
  _scheme_last_normal_type_,            /* 124 */

  scheme_rt_comp_env,                   /* 125 */
  scheme_rt_constant_binding,           /* 126 */
  scheme_rt_resolve_info,               /* 127 */
  scheme_rt_compile_info,               /* 128 */
  scheme_rt_cont_mark,                  /* 129 */
  scheme_rt_saved_stack,                /* 130 */
  scheme_rt_reply_item,                 /* 131 */
  scheme_rt_closure_info,               /* 132 */
  scheme_rt_overflow,                   /* 133 */
  scheme_rt_dyn_wind_cell,              /* 134 */
  scheme_rt_cont_mark_chain,            /* 135 */
  scheme_rt_dyn_wind_info,              /* 136 */
  scheme_rt_dyn_wind,                   /* 137 */
  scheme_rt_dup_check,                  /* 138 */
  scheme_rt_thread_memory,              /* 139 */
  scheme_rt_input_file,                 /* 140 */
  scheme_rt_input_fd,                   /* 141 */
  scheme_rt_oskit_console_input,        /* 142 */
  scheme_rt_tested_input_file,          /* 143 */
  scheme_rt_tested_output_file,         /* 144 */
  scheme_rt_indexed_string,             /* 145 */
  scheme_rt_output_file,                /* 146 */
  scheme_rt_load_handler_data,          /* 147 */
  scheme_rt_pipe,                       /* 148 */
  scheme_rt_beos_process,               /* 149 */
  scheme_rt_system_child,               /* 150 */
  scheme_rt_tcp,                        /* 151 */
  scheme_rt_write_data,                 /* 152 */
  scheme_rt_tcp_select_info,            /* 153 */
  scheme_rt_namespace_option,           /* 154 */
  scheme_rt_param_data,                 /* 155 */
  scheme_rt_will,                       /* 156 */
  scheme_rt_will_registration,          /* 157 */
  scheme_rt_struct_proc_info,           /* 158 */
  scheme_rt_linker_name,                /* 159 */
  scheme_rt_param_map,                  /* 160 */
  scheme_rt_finalization,               /* 161 */
  scheme_rt_finalizations,              /* 162 */
  scheme_rt_cpp_object,                 /* 163 */
  scheme_rt_cpp_array_object,           /* 164 */
  scheme_rt_stack_object,               /* 165 */
  scheme_rt_preallocated_object,        /* 166 */
  scheme_thread_hop_type,               /* 167 */
  scheme_rt_srcloc,                     /* 168 */
  scheme_rt_evt,                        /* 169 */
  scheme_rt_syncing,                    /* 170 */
  scheme_rt_comp_prefix,                /* 171 */
  scheme_rt_user_input,                 /* 172 */
  scheme_rt_user_output,                /* 173 */
  scheme_rt_compact_port,               /* 174 */
  scheme_rt_read_special_dw,            /* 175 */
  scheme_rt_regwork,                    /* 176 */
  scheme_rt_buf_holder,                 /* 177 */
  scheme_rt_parameterization,           /* 178 */
  scheme_rt_print_params,               /* 179 */
#endif
