...
(defvar *scm2cl-fns-named-diff*
  '(
    ...
    #+(or allegro clisp) getenv #+(or allegro clisp) system::getenv
    integer? integerp
    ...
    #+(or allegro clisp) system #+(or allegro clisp) shell
...
(do ((s *scm2cl-fns-named-diff* (cddr s)))
    ((null s))
  (push (cons (car s) `(function ,(cadr s))) *scm2cl-names*))

(do ((s *scm2cl-kwds-named-diff* (cddr s)))
    ((null s))
  (push (cons (car s) (cadr s)) *scm2cl-names*))
