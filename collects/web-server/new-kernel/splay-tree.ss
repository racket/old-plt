(module splay-tree mzscheme
  ...
  (provide splay-tree-imports^ splay-tree^ splay-tree@)
  
  (define-signature splay-tree-imports^ (same? less?))
  (define-signature splay-tree^ (tree-key access insert delete join split smallest largest fold-ascending fold-descending tree-for-each!))
  
  (define splay-tree@
    (unit/sig splay-tree^
      (import splay-tree-imports^)
