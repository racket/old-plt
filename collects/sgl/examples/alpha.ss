...
(define my-gl-init
  (lambda ()
    (let ((res *texture*))
      ...
      (init-textures 3)
      (if (not (gl-load-texture (list-ref res 2) (list-ref res 0) (list-ref res 1) GL_NEAREST GL_NEAREST 0)) 
          (error "Couldn't load texture"))
      (if (not (gl-load-texture (list-ref res 2) (list-ref res 0) (list-ref res 1) GL_LINEAR GL_LINEAR 1)) 
          (error "Couldn't load texture"))
      (if (not (gl-load-texture (list-ref res 2) (list-ref res 0) (list-ref res 1) GL_LINEAR GL_LINEAR_MIPMAP_NEAREST 2)) 
          (error "Couldn't load texture"))
