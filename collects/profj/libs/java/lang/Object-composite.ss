...
;                 ;;;                        
  ...
  ;Object.java
  (provide ObjectI Object-Mix Object @dynamic-Object @static-Object dynamic-Object/c static-Object/c)
  ...
  (define @dynamic-Object
    (class object%
      ...
      (define/public (equals-java.lang.Object obj) 
        (send wrapped equals-java.lang.Object (make-object @static-Object obj)))
      ...
      (define/public (toString)
        (make-java-string (send wrapped toString)))
  ...
  (define dynamic-Object/c
    (object-contract
     (clone (-> any/c))
     (equals-java.lang.Object (-> static-Object/c boolean?))
     (finalize (-> any/c))
     (getClass (-> any/c))
     (hashCode (-> integer?))
     (notify (-> any/c))
     ...
     (toString (-> string?))
     (wait (-> any/c))
     (wait-long (-> integer? any/c))
     (wait-long-int (-> integer? integer? any/c))))
  ...
  (define @static-Object
    (class object%
      ...
      (define/public (clone) (send wrapped clone))        
      (define/public (equals-java.lang.Object obj) 
        (send wrapped equals-java.lang.Object (make-object @dynamic-Object obj)))
  ...
  (define static-Object/c
    (object-contract
     (clone (-> any/c))
     (equals-java.lang.Object (-> static-Object/c boolean?))
     (equals (-> static-Object/c boolean?))
     (finalize (-> any/c))
     (getClass (-> any/c))
     (get-class (-> any/c))
     (hashCode (-> integer?))
...
;Throwable and exceptions
  ...
  (provide @dynamic-Throwable @static-Throwable dynamic-Throwable/c static-Throwable/c)
  
  (define @dynamic-Throwable
    (class object% 
      (init w)
      (define wrapped null)
      (set! wrapped w)
      ...
      (define/public (initCause-java.lang.Throwable cse)
        (make-object @dynamic-Throwable 
          (send wrapped initCause-java.lang.Throwable (make-object @static-Throwable cse))))
      (define/public (getMessage) (make-java-string (send wrapped getMessage)))
      (define/public (getCause) (make-java-string (send wrapped getCause)))
      (define/public (getLocalizedMessage) (make-java-string (send wrapped getLocalizedMessage)))
      ...
      (define/public (toString) (make-java-string (send wrapped toString)))
  ...
  (define dynamic-Throwable/c
    (object-contract
     (initCause (-> static-Throwable/c static-Throwable/c))
     (getMessage (-> string?))
     (getCause (-> string?))
     (getLocalizedMessage (-> string?))
     (setStackTrace-java.lang.StackTraceElement1 (-> any/c any/c))
     (getStackTrace (-> any/c))
     (printStackTrace (-> any/c))
     (printStackTrace-PrintStream (-> any/c))
     (printStackTrace-PrintWriter (-> any/c))
     (fillInStackTrace (-> any/c))
     (clone (-> any/c))
     (equals-java.lang.Object (-> static-Object/c boolean?))
     (finalize (-> any/c))
     (getClass (-> any/c))
  ...
  (define @static-Throwable
    (class object% 
      ...
      (define/public (get-mzscheme-exception) (send wrapped get-mzscheme-exception))
      (define/public (initCause-java.lang.Throwable cse)
        (make-object @static-Throwable 
          (send wrapped initCause-java.lang.Throwable (make-object @dynamic-Throwable cse))))
      (define/public (init-cause c)
        (send wrapped initCause-java.lang.Throwable (make-object @dynamic-Throwable c)))
      ...
      (define/public (getCause) (send (send wrapped getCause) get-mzscheme-string))
      (define/public (get-cause) (send (send wrapped getCause) get-mzscheme-string))
      ...
      (define/public (toString) (send (send wrapped toString) get-mzscheme-string))
      (define/public (to-string) (send (send wrapped toString) get-mzscheme-string))
      (define/public (printStackTrace)  (send wrapped printStackTrace))
      (define/public (printStackTrace-PrintStream printStream) (send wrapped printStackTrace-PrintStream))
      (define/public (printStackTrace-PrintWriter pW) (send wrapped printStackTrace-PrintWriter))
      ...
      (define/public (equals-java.lang.Object obj)
        (send wrapped equals-java.lang.Object (make-object @dynamic-Object obj)))
      (define/public (equals o)
        (send wrapped equals-java.lang.Object (make-object @dynamic-Object o)))
      (define/public (my-name) (send wrapped my-name))
      (define/public (field-names) (send wrapped field-names))
      (define/public (field-values) (send wrapped field-values))
      (define/public (fields-for-display) (send wrapped fields-for-display))
  ...
  (define static-Throwable/c
    (object-contract
     (initCause (-> static-Throwable/c static-Throwable/c))
     (init-cause (-> static-Throwable/c static-Throwable/c))
     (getMessage (-> string?))
     (get-message (-> string?))
     (getCause (-> string?))
     (get-cause (-> string?))
     ...
     (setStackTrace-java.lang.StackTraceElement1 (-> any/c any/c))
     (set-stack-trace (-> any/c any/c))
     (getStackTrace (-> any/c))
     (get-stack-trace (-> any/c))
     (printStackTrace (-> any/c))
     (printStackTrace-PrintStream (-> any/c))
     (printStackTrace-PrintWriter (-> any/c))
     (fillInStackTrace (-> any/c))
     (fill-in-stack-trace (-> any/c))
     (clone (-> any/c))
     (equals-java.lang.Object (-> static-Object/c boolean?))
     (equals (-> static-Object/c boolean?))
     (finalize (-> any/c))
