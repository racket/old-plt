========================================================================
    ACTIVE TEMPLATE LIBRARY : dotnet Project Overview
========================================================================

AppWizard has created this dotnet project for you to use as the starting point for
...
_dotnet.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_dotnet.h)
        GUID definitions                                (_dotnet_i.c)
        A type library                                  (_dotnet.tlb)
        Marshaling code                                 (_dotnet_p.c and dlldata.c)
dotnet.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named dotnet.pch and a precompiled types file named StdAfx.obj.
...
dotnetps.vcproj
	...
	dlldata.c, dotnet_i.c and dotnet_p.c which are required
