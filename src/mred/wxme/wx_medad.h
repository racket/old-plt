...
#define TF_Flag(var) unsigned var : 1
 ...
 public:
  ...
  void InsertImage(char *filename = NULL, long type = wxBITMAP_TYPE_MASK, 
  ...
  void Print(Bool interactive=TRUE, Bool fit=FALSE, int output_mode = 0, wxWindow *parent = NULL, Bool forcePageBBox = TRUE);
