...
;Configured for Scheme dialect plt by scmxlate, v 0L,
;(c) Dorai Sitaram, 
...
(define do-urlh
  (lambda ()
    ...
    (emit "\">")
    (fluid-let ((*doing-urlh?* #t)) (tex2page-string (get-token)))
    (emit "</a>")))
...
(define tex-def-count-global
  (lambda (name num) (tex-def-count name num *global-texframe*)))
