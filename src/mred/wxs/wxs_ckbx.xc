...
@CREATOR (wxPanel!,wxFunction/bCallback/ubCallback/cCallback//spCallback,wxBitmap!,int=-1,int=-1,int=-1,int=-1,SYM[checkboxStyle]=0,string="checkBox"); : : ubCallbackSetup/CHECKOK[2."wx:check-box%::initialization"]|NOZERO[5]|NOZERO[6]//ubCallbackCreatorFinish <> bitmap label
