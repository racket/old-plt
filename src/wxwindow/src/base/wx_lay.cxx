    ...
    case wxCentreY:
    {
      switch (relationship)
      {
        ...
        case wxUnconstrained:
        {
          ...
          if (constraints->bottom.GetDone() && constraints->height.GetDone())
          {
            value = (int)(constraints->left.GetValue() - (constraints->height.GetValue()/2) + margin);
            done = TRUE;
            return TRUE;
          }
...
wxSizer::~wxSizer(void)
{
  ...
  if (sizerParent && sizerParent->__type != wxTYPE_SIZER)
  {
