...
#define scheme_get_evt_via_get (scheme_extension_table->scheme_get_evt_via_get)
#define scheme_peek_evt_via_peek (scheme_extension_table->scheme_peek_evt_via_peek)
