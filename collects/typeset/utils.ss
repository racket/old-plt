(module utils mzscheme
  ...
  (define bracket-snip%
    (class editor-snip% 
      (init-field between-snip left-margin top-margin right-margin bottom-margin)
      (inherit get-editor)
  ...
  ;; bracket : (union string snip) -> snip
